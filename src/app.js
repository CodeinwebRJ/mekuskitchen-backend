...
const TiffinPincodeMaster = require("./routes/TiffinPincodeMaster.route");
const TiffinItemMasterRoute = require("./routes/TiffinItemMaster.route");
...
app.use("/api/v1/pincode-master", TiffinPincodeMaster);
app.use("/api/v1/item-master", TiffinItemMasterRoute);
